...
var RefreshSessionRepository = /** @class */ (function () {
    ...
    RefreshSessionRepository.getRefreshSession = function (refreshToken) {
    ...
    RefreshSessionRepository.createRefreshSession = function (_a) {
        var id = _a.id, refreshToken = _a.refreshToken, fingerprint = _a.fingerprint;
        return __awaiter(this, void 0, void 0, function () {
    ...
    RefreshSessionRepository.deleteRefreshSession = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
